...
- Share track/channel modal with menu: **→ see plan below**

#### Share modal implementation plan

**Context:** PR radio4000/components#193 adds native share to web components. We want similar in r5.
...
- All options visible (no tabs):
  ...
  - Native share button (when `navigator.share` available)
...
- layout-header.svelte: mount ShareModal

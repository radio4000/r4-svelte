...
[reference](reference.json) lists exported functions, [browser-testing](browser-testing.md) for testing. [/settings](/settings) for appearance and account. Data caches locally for offline use. Auth via email or OAuth. [/mix](mix.md) is an experimental DJ mixer page.
